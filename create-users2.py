...
def main():
 # Ask the user if they want to do a dry run
	...
	# and puts it into the groups variable.
        ...
        #These commands will enable the script to actually make changes into the operating system and make real user accounts. If dry-run is running
	...
	#the correct password was added. 
        ...
        # These commands will enable the script to actually make changes into the operating system and make real accounts. It will apply to the
